        ...
        <div>
          <div class="panel">
            ...
            <p style="font-size:13px; color:#64748b; margin:0 0 20px; line-height:1.5;">
              Les donnees sont stockees localement dans votre navigateur. Elles ne sont accessibles
              que depuis cet appareil.
            </p>
            <div class="flex flex-col gap-3">
              <button
                ...
                style="width:100%; border-radius:8px; height:42px;"
              >
                <mat-icon style="font-size:16px;width:16px;height:16px;margin-right:6px;"
                  >refresh</mat-icon
                >
          ...
          <div
            style="margin-top:16px; padding:14px 18px; background:#fffbeb; border:1px solid #fde68a; border-radius:10px; display:flex; gap:10px; align-items:flex-start;"
          >
            <mat-icon style="font-size:16px;width:16px;height:16px;color:#d97706;margin-top:2px;"
              >warning_amber</mat-icon
            >
            <p style="font-size:12px; color:#92400e; margin:0; line-height:1.5;">
              Vider les donnees supprime definitivement toutes les bandes, reproductions et ventes.
              Exportez un CSV depuis la page Rapports avant de continuer.
            </p>
          </div>
        </div>
      </div>
...
export class ParametresComponent {
  ...
  constructor() {
    ...
    this.settingsForm = this.fb.group({
      gestationDays: [
        s.gestationDays,
        [Validators.required, Validators.min(25), Validators.max(35)],
      ],
